...
import { ArrowLeft, Target, Send } from "lucide-react";
...
export default function CustomReportForm() {
  const [formData, setFormData] = useState({
    ...
    entities: '',
    youtubeChannels: '',
    timeline: '5-7 business days (standard)',
    useCase: '',
    name: '',
    email: '',
    company: '',
      ...
      <main className="relative min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white">
        ...
        <section className="relative w-full flex flex-col items-center justify-center pt-32 pb-16 px-6 min-h-screen">
          ...
          >
            ...
            <h1 className="text-4xl font-bold mb-4 text-white">Request Submitted!</h1>
            <p className="text-xl text-gray-300 mb-6">
              Thank you for your custom report request. We&apos;ll contact you within 24 hours to confirm details 
              and may suggest optimizations for better results.
            </p>
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 mb-8 text-left">
              ...
              <ul className="space-y-2 text-gray-300">
                <li>• We&apos;ll review your entity list and YouTube channel selections</li>
                <li>• Our team may suggest additional channels for comprehensive coverage</li>
                <li>• You&apos;ll receive a confirmation email with timeline and payment details</li>
                <li>• Your professional report will be delivered as scheduled</li>
              </ul>
            </div>
    ...
    <main className="relative min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              One-time YouTube-based analytics report with JORDN & RODMN scores
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative w-full px-6 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-xl font-bold text-orange-400 mb-3">Current Analysis Scope:</h2>
            <p className="text-gray-300 mb-4">
              Our analytics are based on YouTube podcast transcripts and discussions. We analyze how your entities 
              are mentioned, discussed, and perceived across the YouTube channels you specify.
            </p>
            
            <h3 className="text-lg font-semibold text-white mb-2">What You&apos;ll Receive:</h3>
            <ul className="space-y-1 text-gray-300">
              <li>• JORDN scores (influence/relevance ratings)</li>
              <li>• RODMN scores (controversy/divisive narrative ratings)</li>
              <li>• Trend analysis and insights</li>
              <li>• Professional PDF report with charts</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder='e.g., "WNBA", "NFL Draft", "Entertainment", "Business/Tech"'
              ...
              <div>
                ...
                >
                  <option value="5-7 business days (standard)">5-7 business days (standard)</option>
                  <option value="Rush delivery 2-3 days (+$200)">Rush delivery 2-3 days (+$200)</option>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="Please provide specific YouTube channel URLs or names where these entities are discussed (e.g., ESPN channels, sports talk shows, podcasts)"
                  className="w-full px-4 py-3 bg-gray-900/50 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:border-orange-500 focus:outline-none resize-none"
                />
                <p className="text-gray-500 text-sm mt-2">
                  This is required for accurate analysis. The more specific channels you provide, the better your results.
                </p>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder='e.g., "Weekly newsletter content", "Social media strategy", "Investment research"'
                  className="w-full px-4 py-3 bg-gray-900/50 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:border-orange-500 focus:outline-none resize-none"
                />
              </div>
